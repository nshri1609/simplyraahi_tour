...
export default function PanchKedarPage() {
  ...
  const locationData = {
    ...
    image:
      "https://images.unsplash.com/photo-1629981352504-b7f5210501c3?w=1920&auto=format&fit=crop&q=100&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8a2VkYXJuYXRofGVufDB8fDB8fHww",
    duration: "12 Days",
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-grow prose max-w-none md:w-2/3">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    The Panch Kedar trek is a sacred pilgrimage to five ancient
                    temples dedicated to Lord Shiva in the Garhwal Himalayas.
                    These temples are Kedarnath, Tungnath, Rudranath,
                    Madhyamaheshwar, and Kalpeshwar. Each temple has its own
                    unique significance and stunning location. The trek takes
                    you through beautiful valleys, dense forests, and high
                    mountain passes, offering breathtaking views of the
                    Himalayan peaks. This spiritual journey combines religious
                    significance with natural beauty, making it a unique
                    experience for both devotees and adventure seekers.
                  </p>
                </div>
