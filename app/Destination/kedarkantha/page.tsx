...
export default function KedarkanthaPage() {
  ...
  const locationData = {
    ...
    description:
      "A winter wonderland trek with stunning snow-covered landscapes",
    image:
      "https://images.unsplash.com/photo-1648043556446-7837cc1da0a4?q=80&w=1951&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    duration: "5 Days",
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-grow prose max-w-none md:w-2/3">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Kedarkantha trek is one of the most popular winter treks in
                    India. Located in the Uttarkashi district of Uttarakhand,
                    this trek offers stunning views of the Himalayan peaks,
                    beautiful meadows, and dense forests. The trek is perfect
                    for beginners and offers a chance to experience snow during
                    the winter months. The summit offers a 360-degree view of
                    major peaks like Swargarohini, Bandarpoonch, and Kala Nag.
                  </p>
                </div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    day: "Day 05",
                    title:
                      "Descend to Sankri from Hargaon and Drive Back to Dehradun",
                    details: [
                  ...
                  <div
                    ...
                    onClick={() =>
                      setExpandedDay(
                        expandedDay === index + 1 ? null : index + 1
                      )
                    }
                  >
