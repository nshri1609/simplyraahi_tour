...
export default function DoDhamPage() {
  ...
  const locationData = {
    ...
    image:
      "https://images.unsplash.com/photo-1571328565610-56f07b8bf3ce?auto=format&fit=crop&q=100&w=1920&h=1080",
    duration: "6 Days",
    ...
    pdfLink:
      "https://drive.google.com/file/d/1wEruLvvBsco_-09r4V91cNUBbhx7bLUe/view?usp=sharing",
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-grow prose max-w-none md:w-2/3">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    The Do Dham Yatra is a sacred pilgrimage to two of the most
                    revered temples in the Garhwal Himalayas - Kedarnath and
                    Badrinath. This spiritual journey takes you through some of
                    the most breathtaking landscapes of Uttarakhand, offering a
                    perfect blend of religious significance and natural beauty.
                    The yatra is not just a religious journey but also an
                    opportunity to experience the majestic Himalayas up close.
                  </p>
                </div>
