...
export default function SarPassPage() {
  ...
  const locationData = {
    title: "SAR PASS TREK",
    description:
      "A challenging trek through beautiful meadows and snow-covered passes",
    image:
      "https://images.unsplash.com/photo-1621025713003-3af00dc78efa?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    duration: "5 Days",
    difficulty: "Moderate",
    altitude: "13,800 ft",
    ...
    pdfLink:
      "https://drive.google.com/file/d/1mbv-MEJQP5TVETLdHtP-FNj-ea-vYezs/view?usp=sharing",
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-grow prose max-w-none md:w-2/3">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    The Sar Pass trek is a captivating journey through the heart
                    of Parvati Valley in Himachal Pradesh. Starting from the
                    charming town of Kasol at 5,577 feet, this trek takes you
                    through dense Rhododendron forests, traditional mountain
                    villages, and snow-covered terrain to reach the magnificent
                    Sar Pass at 13,779 feet. The trek offers a perfect blend of
                    adventure and natural beauty, featuring diverse landscapes
                    from easy riverside walks to challenging snow-covered paths.
                    The highlight of this trek is the gradual progression
                    through distinct terrains - from the cultural immersion in
                    Grahan Village, the last inhabited settlement on the route,
                    to the serene meadows of Mung Thach, and finally the
                    thrilling snow slide descent from Sar Pass to Biskeri Thach.
                    Each day brings new challenges and rewards, making it an
                    ideal trek for both beginners and experienced trekkers
                    looking for a comprehensive Himalayan adventure.
                  </p>
                </div>
