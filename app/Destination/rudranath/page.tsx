...
export default function RudranathPage() {
  ...
  const locationData = {
    title: "RUDRANATH",
    description:
      "Visit the fifth temple of Panch Kedar, where Lord Shiva's face is worshipped",
    image:
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-grow prose max-w-none md:w-2/3">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Rudranath Temple is the third temple in the Panch Kedar
                    circuit, where Lord Shiva's face is worshipped. Located at
                    an altitude of 2,286 meters, this ancient temple is
                    surrounded by dense forests and offers a serene spiritual
                    experience. The temple is known for its unique natural rock
                    formation that resembles Lord Shiva's face. The journey to
                    Rudranath is not just a pilgrimage but also an opportunity
                    to experience the pristine beauty of the Garhwal Himalayas.
                  </p>
                </div>
