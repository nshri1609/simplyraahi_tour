...
export default function MadhyamaheshwarPage() {
  ...
  const locationData = {
    ...
    image:
      "https://images.unsplash.com/photo-1729098754163-ec15cfcf1090?q=80&w=1977&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    duration: "5 Days",
    ...
    gallery: [
      ...
      {
        src: "https://i.pinimg.com/736x/58/fa/fe/58fafefe2f2c982453b84c8486687830.jpg",
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-grow prose max-w-none md:w-2/3">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Madhyamaheshwar is the fourth temple in the Panch Kedar
                    circuit, where Lord Shiva's navel is worshipped. Located at
                    an altitude of 3,497 meters, this ancient temple offers a
                    perfect blend of spiritual significance and natural beauty.
                    The temple is surrounded by snow-capped peaks and offers
                    breathtaking views of the Garhwal Himalayas. The trek to
                    Madhyamaheshwar takes you through beautiful meadows, dense
                    forests, and traditional mountain villages, making it a
                    memorable experience for both devotees and nature lovers.
                  </p>
                </div>
