...
export default function KedarnathPage() {
  ...
  const locationData = {
    title: "KEDARNATH",
    description:
      "Visit the first temple of Panch Kedar, where Lord Shiva's hump is worshipped",
    image:
      "https://images.unsplash.com/photo-1612438214708-f428a707dd4e?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    duration: "5 Days",
    ...
    pdfLink:
      "https://drive.google.com/file/d/1Ue3zK8ymS6VFvECg8hpccdz0dhCqq_b6/view?usp=sharing",
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-grow prose max-w-none md:w-2/3">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Kedarnath Temple is one of the holiest Hindu temples
                    dedicated to Lord Shiva, located at an altitude of 3,583
                    meters in the Garhwal Himalayan range. This ancient temple
                    is part of the Char Dham pilgrimage circuit and is known for
                    its spiritual significance and stunning natural
                    surroundings. The temple is built of large stone slabs and
                    features a unique architecture that has withstood the test
                    of time and natural calamities. The journey to Kedarnath is
                    not just a pilgrimage but also an opportunity to experience
